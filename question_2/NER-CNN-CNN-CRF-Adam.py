...
parameters['name'] = "self-trained-model-cnn_5words"  # Model name
...
class FinalNN(nn.Module):
    ...
    def __init__(self, vocab_size, tag_to_ix, embedding_dim, hidden_dim,
        ...
        self.word_cnn_layer = nn.Conv1d(in_channels=1, out_channels=2*hidden_dim, kernel_size=(embedding_dim+self.out_channels)*5, stride=embedding_dim+self.out_channels, padding=2*(embedding_dim+self.out_channels))
