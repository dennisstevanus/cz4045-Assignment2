...
parameters['name'] = "self-trained-model-cnn-max_pool_1d_1words"  # Model name
...
class FinalNN(nn.Module):
    ...
    def __init__(self, vocab_size, tag_to_ix, embedding_dim, hidden_dim,
        ...
        self.word_cnn_layer = nn.Conv1d(in_channels=1, out_channels=2*hidden_dim, kernel_size=(embedding_dim+self.out_channels)*1, stride=embedding_dim+self.out_channels, padding=0*(embedding_dim+self.out_channels))
